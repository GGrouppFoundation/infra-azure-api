...
partial class GeolocationApi
{
    public ValueTask<Result<GeolocationGetOut, Failure<GeolocationGetFailureCode>>> GetGeolocationAsync(
        GeolocationGetIn input, CancellationToken cancellationToken)
    {
        ...
        return InnerGetGeolocationAsync(input, cancellationToken);
    }

    private async ValueTask<Result<GeolocationGetOut, Failure<GeolocationGetFailureCode>>> InnerGetGeolocationAsync(
        GeolocationGetIn input, CancellationToken cancellationToken)
    {
